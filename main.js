...
function markEvent(evt, title) {
    ...
    if (evt.ctrlKey || (checkVerboseLogging.checked === true && typeof evt.ctrlKey === "boolean")) {
        loggingInfoList.push({text: `altKey: ${evt.ctrlKey}`, title: `Returns true if the ctrl key was down when the mouse event was fired.`})
    }
    if (evt.altKey || (checkVerboseLogging.checked === true && typeof evt.altKey === "boolean")) {
        loggingInfoList.push({text: `altKey: ${evt.altKey}`, title: `Returns true if the alt key was down when the mouse event was fired.`})
    }
    if (evt.shiftKey || (checkVerboseLogging.checked === true && typeof evt.shiftKey === "boolean")) {
